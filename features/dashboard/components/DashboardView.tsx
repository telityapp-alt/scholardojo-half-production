  ...
  if (loading) {
      return (
          <div className="space-y-12 animate-in fade-in duration-500 px-4 flex flex-col items-center justify-center py-40">
              ...
              <p className="font-bold text-slate-300 uppercase tracking-[0.4em] text-sm">Syncing Neural Grid...</p>
          </div>
      );
  }
    ...
    <div className="space-y-12 pb-40 animate-in fade-in slide-in-from-bottom-6 duration-700 max-w-7xl mx-auto px-4">
      ...
      {storageUsage > 85 && (
          <div className="bg-red-50 border-2 border-red-100 p-5 rounded-[28px] border-b-[6px] border-red-200 flex items-center gap-5 text-red-600 animate-pulse shadow-sm">
              ...
              <p className="font-bold text-[10px] uppercase tracking-[0.1em] leading-relaxed">
        ...
        <div className="lg:col-span-4 space-y-10">
             ...
             >
                 ...
                 <div className="relative z-10">
                    ...
                    <h3 className="font-bold text-3xl mb-3 tracking-tighter italic leading-none">Super Ninja</h3>
                    ...
                    <button className="w-full bg-white text-sky-500 py-5 rounded-[24px] font-bold border-b-[8px] border-sky-100 group-active:border-b-0 group-active:translate-y-[8px] transition-all uppercase tracking-widest text-sm shadow-xl">
                        Become Elite
                    </button>
                 </div>
             </div>
             ...
             <div className="bg-white p-8 rounded-[40px] border-2 border-slate-200 border-b-[12px] flex items-center gap-6 group hover:border-sky-300 transition-all">
                ...
                <div>
                    <h4 className="font-bold text-slate-700 italic">Quick Boost</h4>
      ...
      <div className="pt-20 border-t-4 border-slate-200 border-dashed">
          <div className="flex items-center gap-4 mb-10 px-2">
              ...
              <div>
                  <h2 className="text-3xl font-bold text-slate-800 italic">Neural Identity</h2>
                  <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.2em] mt-1">Foundation Data Management</p>
              </div>
          </div>
